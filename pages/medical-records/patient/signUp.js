...
const SignUp = (props) => {
  ...
  const bloodGroupOptions = [
    { key: 'A+', text: 'A+', value: 'A+', style: { fontSize: '20px' } },
    { key: 'A-', text: 'A-', value: 'A-', style: { fontSize: '20px' } },
    { key: 'B+', text: 'B+', value: 'B+', style: { fontSize: '20px' } },
    { key: 'B-', text: 'B-', value: 'B-', style: { fontSize: '16px' } },
    { key: 'AB+', text: 'AB+', value: 'AB+', style: { fontSize: '16px' } },
    { key: 'AB-', text: 'AB-', value: 'AB-', style: { fontSize: '16px' } },
    { key: 'O+', text: 'O+', value: 'O+', style: { fontSize: '16px' } },
    { key: 'O-', text: 'O-', value: 'O-', style: { fontSize: '16px' } },
  ];
        ...
        <Form onSubmit={onSubmitHandler} error={!!errorMessage}>
          ...
          <Form.Field>
            ...
            <Dropdown
              ...
              onChange={(event, data) => setBloodGroup(data.value)}
            />
          </Form.Field>
          <Form.Field>
